...
import xyz.fortern.weather.command.WeatherInfoCommand;
import xyz.fortern.weather.listener.AllListener;
...
public final class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        plugin = this;
        Objects.requireNonNull(Bukkit.getPluginCommand("weatherinfo")).setExecutor(new WeatherInfoCommand());
